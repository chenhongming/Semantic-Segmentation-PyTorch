...
# RGB for Cityscapes
citys20 = {0: [0, 0, 0], 1: [128, 64, 128], 2: [244, 35, 232], 3: [70, 70, 70], 4: [102, 102, 156],
           5: [190, 153, 153], 6: [153, 153, 153], 7: [250, 170, 30], 8: [220, 220, 0], 9: [107, 142, 35],
           10: [152, 251, 152], 11: [0, 130, 180], 12: [220, 20, 60], 13: [255, 0, 0], 14: [0, 0, 142],
...
priv = {0: [0, 0, 0], 1: [0, 0, 255], 2: [0, 255, 0], 3: [255, 0, 0]}


def dict_rgb2bgr(colordict):
    bgr = dict()
    keys = colordict.keys()
    for k in keys:
        bgr[k] = colordict[k][::-1]
...
def set_colors(dataset_name):
    if dataset_name in color_map.keys():
        return color_map[dataset_name]
    else:
        raise Exception("{} is not a valid dataset name".format(dataset_name))
